...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\textwidth]{./figs/Figure_1_Algorithm.pdf}
\caption{\csentence{Schematic of the dynamic optimization with particle swarms (DOPS) approach.} \textbf{A}: Each particle represents an N dimensional parameter vector.
