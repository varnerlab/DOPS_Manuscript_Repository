...
A differentiating feature of DOPS compared to the other meta-heuristics is the switch to dynamically dimensioned search following stagnation of the initial particle swarm phase.
...
All other algorithm parameters remained the same for each of these searches.
...
The multi-swarm particle swarm optimization phase stagnated within the first 25\% of the available function evaluations irrespective of the number of sub-swarms.
