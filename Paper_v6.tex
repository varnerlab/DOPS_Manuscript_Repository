...
%\includegraphics[width=0.60\textwidth]{./figs/Figure_2_TestFunctions-crop.pdf}
    \subfloat[]{{\includegraphics[width=.6\textwidth]{./rachelfigs/ackley_10d} }}%
    \newline
    \subfloat[]{{\includegraphics[width=.6\textwidth]{./rachelfigs/rast_10d} }}%
    \newline
    \subfloat[]{{\includegraphics[width=.6\textwidth]{./rachelfigs/rast_300d} }}%
...
\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=1.0\textwidth]{./rachelfigs/RecreateFigure4.pdf}
...
\includegraphics[trim = {3cm 6cm 3cm 6cm }, clip,width = 1.0\textwidth]{./rachelfigs/RecreateFigure7}
...
\begin{figure}[h]
\centering
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/2versionsofDOPSOnb4_obj.pdf} }}
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/2versionsofDOPSOnEggholder}} }%
        \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/2versionsofDOPSOnstybtang}} }%    
        \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/2versionsofDOPSOnfitCoagShrinkFactor1E6}} }%    
...
The results presented are the average of $\mathcal{T}$ = 250 trials with for the CHO metabolism problem and $\mathcal{T}$ = 500 trials on the Eggholder and Styblinksi-Tang functions with $\mathcal{N}$ = 4000 function evaluations each, and $\mathcal{T}$ = 25 trials for the coagulation problem.
...
\caption{\textbf {(Data fits for Problem B1)} Pseudo-experimental data (red x) vs. optimal solution obtained using DOPS (solid blue lines) for the 44 observed states. X axis: time [s]; Y axis: metabolite concentrations [mM].
}\label{fig-sims-b1}
\end{figure}
...
%\includegraphics[width=1.00\textwidth]{./figs/Figure_S3_B1_B4_params_measuredstates.pdf}
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreatedFigureS3a} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreatedFigureS3b} }}%
    \qquad
        \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreatedFigureS3c} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreatedFigureS3d} }}%
...
\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreateRebutalReviewer1_FigS4a} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/RecreateRebutalReviewer1_FigS4b} }}%
    \caption{Mean onvergence curves for different metaheuristics for (a) Ackley 300 dimensional and (b) Rastrigin 300 dimensional with $\mathcal{T}$ = 25 trials per method. DOPS not only finds a better solution than any other technique, it finds it with fewer function evaluations}%
    \label{fig-more-methods}%
\end{figure}

\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/CompareExperimentalDOPSToESSOnProblemB4} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/CompareExperimentalDOPSToESSOnCoag} }}%
...
\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/DOPSDispersionCurvesOnb4} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/DOPSDispersionCurvesOnCoag} }}%
...
\begin{figure}%
    \centering
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/FigureS7a} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/FigureS7b} }}%
    \qquad
        \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/FigureS7c} }}%
    \qquad
    \subfloat[]{{\includegraphics[trim = {3cm 7cm 3cm 7cm }, clip,width=.45\textwidth]{./rachelfigs/FigureS7d} }}%
