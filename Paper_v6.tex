...
\begin{figure}%
    ...
    \caption{Mean convergence curves for DOPS and ESS for (a) CHO model (problem B4) (b) coagulation with $\mathcal{T}$ = 25 trials per method.}%
...
\begin{figure}%
    ...
    \caption{Dispersion curves for DOPS on (a) CHO model (problem B4) (b) coagulation with $\mathcal{T}$ = 25 trials per problem .}%
...
\begin{figure}%
    ...
    \caption{Variability  analysis in best objective value for $\mathcal{T}$ = 25 trials. (a) Ackley  300 dimensional (b) Rastrigin 300 dimensional (c) CHO model (problem b4) (d) coagulation. }%
